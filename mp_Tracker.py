...
class Tracker(SLAMParameters):
    ...
    def tracking(self):
        ...
        save_colmap.save_images(self)
        save_colmap.save_gt_poses_continus_error(self)
        save_colmap.save_gt_poses(self)
        save_colmap.save_gt_poses_random_error(self)
